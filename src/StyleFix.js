...
(function(window, undefined) {
	...
	function linkElement(link) {
		if (link.rel !== "stylesheet" || (link.hasAttribute ? link.hasAttribute("data-ignore") : link.attributes.getNamedItem("data-ignore"))) {
			return;
		}

		link.setAttribute("data-ignore", "");
		load(link.href, {
